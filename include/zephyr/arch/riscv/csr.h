...
#define csr_read(csr)                                                                              \
	({                                                                                         \
		...
		__asm__ volatile("csrr %0, " STRINGIFY(csr) : "=r"(__rv));                         \
		__rv;                                                                              \
	})
...
#define csr_cap_read(csr)                                                                          \
	({                                                                                         \
		...
		__asm__ volatile("cspecialr %0, " STRINGIFY(csr) : "=r"(__rv));                    \
		__rv;                                                                              \
	})
#endif
...
#define csr_write(csr, val)                                                                        \
	({                                                                                         \
		...
		__asm__ volatile("csrw " STRINGIFY(csr) ", %0" : : "rK"(__wv) : "memory");         \
	})
...
#define csr_cap_write(csr, val)                                                                    \
	({                                                                                         \
		...
		__asm__ volatile("cspecialw " STRINGIFY(csr) ", %0" : : "rK"(__wv) : "memory");    \
	})
#endif
...
#define csr_set(csr, val)                                                                          \
	({                                                                                         \
		...
		__asm__ volatile("csrs " STRINGIFY(csr) ", %0" : : "rK"(__sv) : "memory");         \
	})
...
#define csr_clear(csr, val)                                                                        \
	({                                                                                         \
		...
		__asm__ volatile("csrc " STRINGIFY(csr) ", %0" : : "rK"(__v) : "memory");          \
	})
