...
#define CHERI_PERM_DEVICE_MEMORY                                                                   \
	(~(CHERI_PERM_CAP | CHERI_PERM_EXECUTE | CHERI_PERM_SYSTEM_REGS | CHERI_PERM_LOAD_MUTABLE))
 ...
 * (so includes other fields), use ~ to remove a permission from a capability.
 */
...
#define CHERI_PERM_EXECUTABLE_AND_LOADSTORE                                                        \
	(~(CHERI_PERMIT_SEAL | CHERI_PERMIT_CINVOKE | CHERI_PERMIT_UNSEAL | CHERI_PERMIT_SET_CID))

/* Capability permissions for Executable */
#define CHERI_PERM_EXECUTABLE                                                                      \
	(~(CHERI_PERMIT_STORE | CHERI_PERMIT_SEAL | CHERI_PERMIT_CINVOKE | CHERI_PERMIT_UNSEAL |   \
	   CHERI_PERMIT_SET_CID))

/* Capability permissions for Interrupt stacks */
#define CHERI_PERM_INTERRUPT_STACKS                                                                \
	(~(CHERI_PERMIT_EXECUTE | CHERI_PERMIT_SEAL | CHERI_PERMIT_CINVOKE | CHERI_PERMIT_UNSEAL | \
	   CHERI_PERMIT_SET_CID))
...
/* Permit normal load and stores only */
#define CHERI_PERM_DEVICE_MEMORY                                                                   \
	(~(CHERI_GLOBAL | CHERI_PERMIT_EXECUTE | CHERI_PERMIT_LOAD_CAPABILITY |                    \
	   CHERI_PERMIT_STORE_CAPABILITY | CHERI_PERMIT_STORE_LOCAL_CAPABILITY |                   \
	   CHERI_PERMIT_SEAL | CHERI_PERMIT_CINVOKE | CHERI_PERMIT_UNSEAL | CHERI_PERMIT_SET_CID))
