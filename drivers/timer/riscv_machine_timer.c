...
#warning DT_INST_REG_SIZE_BY_IDX(0, 0) may be too small for CHERI in timer, default to 0x08
#endif
...
/*
 * #warning Check DT_INST_REG_SIZE_BY_IDX(0, 1) in device tree is not too small for CHERI in
 * riscv_machine_timer, defaulting to 0x00000010
 */
#endif
