...
/* Function prototype for the getSBoxVaue function
 * REIMPLEMENTED in tables.s
 */
extern uint8_t getSBoxValue(uint8_t num);
...
/* Function prototype for the getRcon function
 * REIMPLEMENTED in tables.s
 */
extern uint8_t getRcon(uint8_t num);

#if (defined(CBC) && CBC == 1) || (defined(ECB) && ECB == 1)

/* Function prototype for the getSBoxInvert function
 * REIMPLEMENTED in tables.s
 */
extern uint8_t getSBoxInvert(uint8_t num);
