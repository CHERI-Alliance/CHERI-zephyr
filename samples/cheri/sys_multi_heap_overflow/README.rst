.. zephyr:code-sample:: sys_multi_heap_overflow
   :name: sys_multi_heap_overflow

   CHERI sys_multi_heap overflow

Overview
********

A sample that demonstrates CHERI with an overflow
on an allocated block from a multi-heap
...
.. zephyr-app-commands::
   :zephyr-app: samples/cheri/sys_multi_heap_overflow
   :host-os: unix
...
Running CHERI multi-heap overflow sample on qemu_riscv32cheri_zcheripurecap/qemu_virt_riscv32
multi_heap allocation address: 0x80010ab0
CHERI addr:   0x80010ab0
CHERI base:   0x80010ab0
CHERI top:   0x80010b30
CHERI length: 128
CHERI tag: 1
...
E: Current thread: 0x80010c80 (unknown)
>>> k_sys_fatal_error_handler: reason=0 esf=0x80011ea0
