.. zephyr:code-sample:: modbus-rtu-client-cheri
   :name: Modbus RTU client
   :relevant-api: modbus

   Communicate with a Modbus RTU server with CHERI support.

Overview
********

This is a simple application demonstrating a Modbus RTU client implementation
in Zephyr RTOS with CHERI support.

**Note:** This is currently WiP, so ignore most of the below README.
